...
\begin{itemize}
	...
	\item sviluppo di un'interfaccia \textit{front-end} che rispettasse le tematiche presenti all'interno della libreria
	\item sviluppo di \gls{stub} che simulino il comportamento del \textit{back-end} per verificare il corretto funzionamento dell'interfaccia.
\end{itemize}
